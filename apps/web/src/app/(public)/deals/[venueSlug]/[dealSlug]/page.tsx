...
import { MapPin, Clock, Calendar, Phone, Globe, Share2, ChevronRight, ExternalLink } from 'lucide-react'
...
function ShareSection({ dealUrl, dealTitle }: { dealUrl: string; dealTitle: string }) {
